	...
	["DRUID"] = {
		{
			...
			Opacity = 1,
			Mode = "ICON",
			setPoint = { "RIGHT", UIParent, "CENTER", -300, -246 },
		...
		},
		{
			...
			Opacity = 1,
			Mode = "ICON",
			setPoint = { "LEFT", UIParent, "CENTER", 300, -246 },
	...
	["SHAMAN"] = {
		{
			...
			Interval = 4,
			Mode = "ICON",
			setPoint = { "RIGHT", UIParent, "CENTER", -346, -246 },
	...
	["ALL"] = {
		{
			...
			Interval = 4,
			Mode = "ICON",
			setPoint = { "RIGHT", UIParent, "CENTER", -300, -270 },
		...
		},
		{
			...
			Interval = 4,
			Mode = "ICON",
			setPoint = { "RIGHT", UIParent, "CENTER", -300, -150 },
		...
		},
		{
			...
			Interval = 4,
			Mode = "ICON",
			setPoint = { "LEFT", UIParent, "CENTER", 300, -150 },
