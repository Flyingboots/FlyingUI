...
local function chatsetup()
	...
	ChatFrame_AddMessageGroup(ChatFrame1, "GENERAL")
	ChatFrame_AddMessageGroup(ChatFrame1, "TRADE")
	ChatFrame_AddMessageGroup(ChatFrame1, "LOCAL_DEFENSE")
	ChatFrame_AddMessageGroup(ChatFrame1, "GUILD_RECRUITMENT")
