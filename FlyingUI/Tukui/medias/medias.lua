...
C["media"] = {
	...
	["font"] = [=[Interface\Addons\Tukui\medias\fonts\expressway rg.ttf]=], -- general font of tukui
	["uffont"] = [[Interface\AddOns\Tukui\medias\fonts\visitor1.ttf]], -- general font of unitframes
	["dmgfont"] = [[Interface\AddOns\Tukui\medias\fonts\normal_font.ttf]], -- general font of dmg / sct
	["pixelfont"] = [[Interface\AddOns\Tukui\medias\fonts\visitor1.ttf]], -- Pixelfont used for different things.
	
	-- fonts (DEUTSCH)
	["de_font"] = [=[Interface\Addons\Tukui\medias\fonts\normal_font.ttf]=], -- general font of tukui
	["de_uffont"] = [[Interface\AddOns\Tukui\medias\fonts\visitor1.ttf]], -- general font of unitframes
	["de_dmgfont"] = [[Interface\AddOns\Tukui\medias\fonts\normal_font.ttf]], -- general font of dmg / sct
	
	-- fonts (FRENCH)
	["fr_font"] = [=[Interface\Addons\Tukui\medias\fonts\normal_font.ttf]=], -- general font of tukui
	["fr_uffont"] = [[Interface\AddOns\Tukui\medias\fonts\visitor1.ttf]], -- general font of unitframes
	...
	-- textures
	["normTex"] = [[Interface\AddOns\Tukui\medias\textures\smellyTex]], -- texture used for tukui healthbar/powerbar/etc
