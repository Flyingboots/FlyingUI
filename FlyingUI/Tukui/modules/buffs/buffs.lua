...
local function UpdateWeapons(button, slot, active, expiration)
	if not button.texture then
		...
		button.bg:CreatePanel("Transparent", 30, 30, "CENTER", button, "CENTER", 0, 0)
...
ScanAuras(CreateAuraHeader("HELPFUL", "TOPRIGHT", -150, -5))
ScanAuras(CreateAuraHeader("HARMFUL", "TOPRIGHT", -150, -129))
